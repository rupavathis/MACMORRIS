          ...
          <Box sx={{ bgcolor: '#f5f2f', textAlign: "justify" }}>
            ...
            {!changeIrish &&
              <>
                ...
                {/* <div className="image-wrapper"> */}
                {/* <img src="/images/case-studies/spenser/fig3.webp" alt="" style={{ width: "100%", height: "auto", margin: 0 }} /> */}
                {/* <figcaption> The Ruins of Kilcolman Castle. Courtesy of Tom Herron. </figcaption> */}
                <section className="insider-subscribe">
                  <div className="page-container">
                    <div className="insider-subscribe__card">
