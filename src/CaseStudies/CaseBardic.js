            ...
            <Container fixed>
                <Box sx={{ height: '100vh' }}>
                    <div className="chapter-header-media chapter-header-media--featured-image">
                        <img src="/images/case-studies/bardic.jpg" alt="" style={{ opacity: 0.5, width: "auto", height: "400px" }} />
...
<br />
                        ...
                        <p className='para-style'><strong>Metre & Register</strong></p>
                        ...
                        <p className='para-style'><strong>The End of the Bardic Tradition</strong></p>
