                ...
                <>
                    <div className='case-study-top-wrapper'>
                        <div className='case-study-title-wrapper'>
                            <h1 className="header-title"><strong>Historical Overview</strong></h1>
                        </div>
                        ...
                        {!changeIrish &&
                            <>
                                ...
                                <div className='case-flex-row'>
                                    ...
                                    <div className='para-flex'>
                                        <p className='para-style'>Thirty-five grantees received seignories in 1588 was thirty-five, the most famous being <Link to='/profile/m1738'>Sir Walter Raleigh</Link> who received 40,000 acres in east Cork and west Waterford including <Link to='/map?id=D1180'>Youghal</Link> and <Link to='/map?id=D1175'>Lismore</Link>. The mathematician, <Link to='/profile/m4296'>Thomas Hariot</Link>, took up residence in <Link to='/map?id=D1174'>Molana Abbey</Link>, on Raleigh’s vast estate. Other undertakers included <Link to='/profile/m1438'>William Herbert</Link>, author of <Link to='/works/87'>Croftus, sive de Hibernia liber</Link>,  who was granted 13,276 acres around <Link to='/map?id=D1125'>Castleisland</Link>; <Link to='/profile/m1502'>Thomas Norris</Link>, later Lord President of Munster, acquired 6,000 acres that included <Link to='/map?id=D1198'>Mallow</Link>; <Link to='/profile/m1614'>Christopher Hatton</Link>, Lord Chancellor of England, and dedicatee of works by <Link to='/profile/m1725'>Barnaby Rich</Link> and <Link to='/profile/m3513'> Thomas Churchyard</Link>, got 10,910 acres in Co. Waterford; and <Link to='/profile/m1506'>Edmund Spenser</Link>, author of the <Link to='/works/5'>Faerie Queene</Link>, was granted 3,028 acres at <Link to='/map?id=D1008'>Kilcolman</Link>. From the start, several challenges faced the undertakers. They were never able to fill their quotas for imported labour from England and had to rely on local labour. Native landholders mounted legal challenges, as illustrated by Spenser’s legal battle with <Link to='/profile/m1507'>Maurice Roche</Link> over <Link to='/map?id=D1008'>Kilcolman</Link>. In 1598, the plantation was set ablaze by troops led by <Link to='/profile/m1514'>Aodh Mág Uidhir</Link>. Spenser was burnt out of <Link to='/map?id=D1008'>Kilcolman</Link> and fled to London, dying a few months later. (see <Link to='/spenser-in-munster'>Edmund Spenser in Munster</Link>).
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className='case-flex-column'>
                                    <div className='para-flex'>
                                        <p className='para-style'>Writers responded robustly to the conflict and uncertainty which they lived through. The filidh (hereditary professional poets), products of the flourishing bardic schools, where powerful figures within the lordships of Gaelic and Gaelicised Ireland, a centrality that condemned them in the eyes of the incoming Tudor administrators (see <Link to='/what-is-bardic-poetry'>What is Bardic Poetry?</Link> and <Link to='/using-gaelic-sources'>Using Gaelic Sources</Link>). Neo-Latin scholarship took on the energies of the Counter-Reformation, not just in theological writings but in histories like <Link to='/profile/m2140'>Philip O’Sullivan Beare’s</Link><Link to='/works/3123'>Historiae Catholicae Iberniae compendium</Link>; and it produced epics like <Link to='/profile/m3476'>Dermot O’Meara’s</Link><Link to='/works/1190'>Ormonius</Link>.  At the same time, the English of Ireland had its own vitality, evident in <Link to='/profile/m1740'>Richard Stanihurst’s</Link> highly experimental translation of Virgil his Aeneid and his contribution to <Link to='/works/175'>Holinshed’s Chronicles</Link>, which includes his celebration of <Link to='/profile/m2462'>Domhnall Dubh Ó Cathail</Link> from <Link to='/map?id=D1019'>Aghadoe</Link>. <Link to='/profile/m3943'>Richard Nugent’s</Link> sonnet collection, <Link to='/works/116'>Cynthia</Link> (1602) may be stylistically more conventional, but Nugent’s <Link to='/network?id=m3943'>network</Link> points to a wider literary and linguistic plurality: his father, <Link to='/profile/m1809'>William Nugent</Link>, was an accomplished sonneteer in English who also wrote poems of exile in the strict deibhidhe metre of the bardic schools, <Link to='/works/3617'>Diombáidh triall ó thulchaibh Fáil</Link> and <Link to='/works/3710'>Fada i n-éagmais inse Fáil</Link>. Richard’s uncle, <Link to='/profile/m2215'>Christopher Nugent</Link>, Baron of Delvin, wrote an <Link to='/works/3069'>Irish primer</Link> (with parallel phrases in Irish, English and Latin) to encourage <Link to='/profile/m1089'>Queen Elizabeth I</Link> to learn Irish, and the Nugent family maintained their own hereditary bards, the muintir Chobhthaigh, evidenced by <Link to='/profile/m2023'>Muircheartach Ó Cobhthaigh’s</Link> <Link to='/works/3656'> Do-ní clú áit oighreachda </Link> and <Link to='/works/3798'>Geall re hiarlachd ainm barúin</Link>.
                                        </p>

                                        <p className='para-style'>The agents of the Tudor and Stuart conquest, too, included a striking number of writers, among them <Link to='/profile/m3513'>Thomas Churchyard</Link>, <Link to='/profile/m4296'>Thomas Hariot</Link>, <Link to='/profile/m1438'>William Herbert</Link>, <Link to='/profile/m1738'>Sir Walter Raleigh</Link>, <Link to='/profile/m1725'>Barnaby Rich</Link>, and <Link to='/profile/m1506'>Edmund Spenser</Link>.  <Link to='/profile/m1667'>John Harrington</Link>, translator of <Link to='/works/120'>Orlando Furioso</Link> and author of several books of <Link to='/works/126'>epigrams</Link>, left a witty record of his Irish campaigns, including a description of <Link to='/map?id=D1173'>Duncannon Fort</Link> and a facetious reference to Morris dancing at <Link to='/map?id=D1172'>Adare</Link>; <Link to='/profile/m1664'>Lodowick Bryskett</Link> praises Spenser in his <Link to='/works/117'>A discourse of ciuill life</Link>; and <Link to='/profile/m1870'>Fynes Moryson</Link> discusses the insolent papists of <Link to='/map?id=D1017'>Cork</Link> in his <Link to='/works/227'>Itinerary</Link>.
                                        </p>
